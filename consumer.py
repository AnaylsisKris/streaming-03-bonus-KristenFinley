...
def main():
    ...
    channel.queue_declare(queue="netflix_queue")

     # define a callback function to be called when a message is received
    def callback(ch, method, properties, body):
        with open('recieved_message.csv', 'a') as file:
    ...
    channel.basic_consume(queue="netflix_queue", on_message_callback=callback, auto_ack=True)
